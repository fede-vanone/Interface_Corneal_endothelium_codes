...
The model we consider is the cellular model. 
...
The function model_main.m runs the cellular model cell_full.m with the permeabilities 
from matrix X corresponding to the run_num specified as input. The other parameters 
needed for cell_full.m are taken from pars5.m.
